...
public class AllMarketReturnsQRCodes_KH {
    ...
    public void ClickNBack(WebDriverWait wait, AndroidDriver driver, String packageName) {
        ...
        String text = "All Market Returns"+newline+"QR Codes";
        System.out.println(text);
        String scrollElement = "new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text(\"All Market Returns\"+\n+\"QR Codes\").instance(0))";
        driver.findElementByAndroidUIAutomator(scrollElement).click();
        driver.findElement(By.id(packageName+":id/all_market_qr_code")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
